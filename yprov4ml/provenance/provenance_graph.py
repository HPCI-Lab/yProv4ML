...
def create_prov_document() -> prov.ProvDocument:
    ...
    rootstr.add_attributes({f"{PROV4ML_DATA.PROV_PREFIX}:endedAtTime": _log_param_value(get_time(), "xsd:dateTime")})
    ...
    for (name, ctx) in PROV4ML_DATA.metrics.keys():
        ...
        attrs = {
            ...
            f'{PROV4ML_DATA.PROV_PREFIX}:generatedAtTime': _log_param_value(generation_time, "xsd:dateTime")
        }
